...
public class RunningcubaTestContainer extends TestContainer {

    public RunningcubaTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "fr/bjacob/runningcuba/app.properties",
    ...
    public static class Common extends RunningcubaTestContainer {

        public static final RunningcubaTestContainer.Common INSTANCE = new RunningcubaTestContainer.Common();
